...
For the Zoom Mode, it opens an interactive window where you can click on the image, zoom in 4x (up to a scale of ~10e-12) and generate a gif of the zoom in journey (see zoom_frames/zoom.gif) for an example: 
